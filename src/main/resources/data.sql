...
--Plan de Estudio
INSERT INTO plan_estudio (ano_aprobacion, cantidad_ciclos, codigo_carrera, duracion_anos, nombre_carrera, modalidad, periodicidad, imagenes_relacionadas ,id_grado) Values (2022, 3, 6000002, 4, 'Informática', 'Presencial', 'Semestral', 0, 1);
SET @plan_estudio_id = LAST_INSERT_ID();

INSERT INTO plan_estudio (ano_aprobacion, cantidad_ciclos, codigo_carrera, duracion_anos, nombre_carrera, modalidad, periodicidad, imagenes_relacionadas, id_grado) Values (2022, 3, 6000003, 4, 'Maestria', 'Presencial', 'Semestral', 0, 1);
SET @plan_estudio_id = LAST_INSERT_ID();
